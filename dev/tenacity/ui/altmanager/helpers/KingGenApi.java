...
public class KingGenApi {
    ...
    public void refreshKey() {
        ...
        try {
            fileContent = new JsonParser().parse(new FileReader(kingAltData)).getAsJsonObject();
        ...
        JsonObject responseObject = new JsonParser().parse(request.getContent()).getAsJsonObject();
    ...
    public final String[] genAlt() {
        ...
        if (key.isEmpty()) {
            try {
                ...
                JsonObject fileContent = new JsonParser().parse(reader).getAsJsonObject();
