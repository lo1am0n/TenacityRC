...
public class LoginPanel extends Panel {
    ...
    public LoginPanel() {
        ...
        actionButtons.add(new ActionButton("Token"));
            ...
            actionButton.setClickAction(() -> {
                switch (actionButton.getName()) {
                    ...
                    case "Token":
                        ...
                        try {
                            clipData = (String) Toolkit.getDefaultToolkit()
                        ...
                        if (clipData == null) break;

                        Tenacity.INSTANCE.getAltManager().getUtils().microsoftLoginAsyncTOKEN(clipData);
                        Tenacity.INSTANCE.getAltManager().getAltPanel().refreshAlts();
                        break;
                }
            });
