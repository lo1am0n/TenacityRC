...
public class ArrayListMod extends Module {
    ...
    private final ModeSetting rectangle = new ModeSetting("Rectangle", "Outline", "None", "Top", "Side", "Outline");
    ...
    private final BooleanSetting backgroundColor = new BooleanSetting("Background Color", true);
