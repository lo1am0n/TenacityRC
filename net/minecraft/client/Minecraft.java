...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    /**
     * A 10 MiB preallocation to ensure the heap is reasonably sized.
     */
    ...
    private void setInitialDisplayMode() throws LWJGLException {
        if (this.fullscreen) {
            ...
            //TENACITY: Here is where u change the screen width and height on startup
            //this.displayWidth = 856;
            //this.displayHeight = 482;
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (int k2 = 0; k2 < list.size(); ++k2) {
                ...
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", j + i - 50 - this.fontRendererObj.getStringWidth(s1), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.getColor());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", j + i - this.fontRendererObj.getStringWidth(s1), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.getColor());
            }
        }
    }
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            if (this.currentScreen == null && Keyboard.isKeyDown(Keyboard.KEY_MINUS) && flag) {
                this.displayGuiScreen(new GuiChat("-"));
            }
